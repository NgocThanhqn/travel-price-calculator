...
const PriceCalculator = () => {
  ...
  return (
    <div ref={formRef} className="max-w-4xl mx-auto p-2 md:p-6 bg-white shadow-lg rounded-lg form-compact">
      {/* Title - Responsive */}
      <h1 className="text-xl md:text-3xl font-bold text-center mb-4 md:mb-8 text-gray-800">
        Tính Giá Chuyến Đi
      </h1>
